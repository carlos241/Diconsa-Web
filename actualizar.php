...
<body>
    ...
    <div class="row" style="display: flex;width: 100%;">
        <div class="col-2">
            <img src="actualizar.png" style="width: 45px; margin-left: 20px; margin-top: 5px;">
        </div>
        <div class="col-10">
            <h2 style="font-size: 20px; text-align: center; margin-top: 15px;">ACTUALIZAR PRODUCTOS</h2>
        </div>
    </div>
    <br>
    ...
    <form>
        ...
        <div class="form-group row">
            <div class="col-sm-10">
                <button type="submit" style="margin-left: 40%; margin-top: 10px; margin-bottom: 10px;" class="btn btn-primary">Actualizar</button>
            </div>
        </div>
